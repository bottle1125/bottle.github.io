...
function renderChart() {
    ...
    title.innerHTML=city+"2016年"+gradTime+"平均空气质量检测";
    aqiChartWrap.appendChild(title);
    var width = 0,left=null,classN=null;
    if(gradTime === "日"){
        left = 13;
        classN = "by-day";
    }else if(gradTime === "周"){
...
function graTimeChange() {
    ...
    formGraTime.onchange = function(){
        ...
        var spans = formGraTime.getElementsByTagName("span");
